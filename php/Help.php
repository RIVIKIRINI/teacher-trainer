...
<html>
  <head>
  <title>Help-The Tutor-Online Teacher Traniner Institute</title>
  ...
  <!-- Content star -->
  <div id="content">
    <br><h1>"THE TUTOR" <br>Online Teacher Traning Institute</h1>
      <br>
        <div class="form">
            <form onsubmit="return validateForm()"method="POST" action="/Help.php">
                <h2>HI! THERE WE ARE HERE TO HELP</h2>
                <div>
                ...
                <div>
                    ...
                    <input type="Email" id="Email" required="@gmail.com" name="n2">
                </div>
                <div>
                    <label for="help">How can we help you</label>
                    <textarea name="n3" id="help" cols="100" rows="10" placeholder="You can ask questions or say the dificulties that you are facing "></textarea><br>
